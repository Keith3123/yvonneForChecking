...
<div id="terms-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 backdrop-blur-sm">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg mx-4 flex flex-col max-h-[80vh]">
        ...
        <div class="flex items-center justify-between p-5 border-b border-gray-100">
            <h2 class="text-base font-semibold text-gray-800">Terms & Conditions</h2>
        ...
        {{-- Scrollable Content --}}
        <div class="overflow-y-auto p-5 text-sm text-gray-600 space-y-4 flex-1">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Clicking "I Agree" checks the checkbox and closes
    acceptBtn?.addEventListener('click', () => {
        if (checkbox) checkbox.checked = true;
        // Hide the terms error if it was shown
