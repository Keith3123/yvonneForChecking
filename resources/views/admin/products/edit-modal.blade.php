<div id="editModal" class="fixed inset-0 hidden z-50 flex items-center justify-center">
    ...
    <div class="bg-white rounded-xl p-6 w-full max-w-md z-50 pointer-events-auto">
        ...
        <form id="editProductForm" enctype="multipart/form-data" data-action="">
            ...
            <input type="text" id="editName" name="name" required class="w-full border p-2 mb-2 rounded border-pink-200">

            <label>Product Category</label>
            <select id="editCategory" name="productTypeID" required class="w-full border p-2 mb-2 rounded border-pink-200">
                @foreach($types as $t)
            ...
            <textarea id="editDescription" name="description" class="w-full border p-2 mb-2 rounded border-pink-200"></textarea>

            <label>Status</label>
            <select id="editStatus" name="isAvailable" class="w-full border p-2 mb-2 rounded border-pink-200">
                <option value="1">Available</option>
                <option value="0">Unavailable</option>
            </select>

            <label>Image (Optional)</label> 
            <input type="file" id="editImage" name="imageURL" accept="image/*" class="w-full mb-4  border p-2 rounded border-pink-200">
