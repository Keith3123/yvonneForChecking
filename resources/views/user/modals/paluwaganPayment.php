...
<div id="payment-modal"
    ...
    <div class="bg-white w-full max-w-md rounded-2xl shadow-2xl flex flex-col"
        ...
        <div class="overflow-y-auto flex-1 p-5 space-y-4" style="min-height: 0;">
            ...
            <div class="bg-pink-50 rounded-xl p-3 space-y-1">
                ...
                <div id="payment-release-date-row" class="hidden flex items-center gap-1.5 mt-1">
                    <span class="text-purple-500">📦</span>
                    <p class="text-xs text-gray-600">
                        Delivery deadline:
                        <span id="payment-release-date" class="font-semibold text-purple-700"></span>
                    </p>
                </div>
            </div>
                ...
                <div class="relative">
                    ...
                    <input type="number"
                           ...
                           class="w-full border-2 border-gray-200 rounded-xl pl-10 pr-4 py-2.5
                                  focus:border-pink-400 focus:outline-none font-semibold text-base transition">
                </div>
                <p id="payment-amount-error" class="text-red-500 text-xs mt-1 hidden"></p>

                <!-- Quick buttons -->
                <div class="flex flex-wrap gap-1.5 mt-2" id="quick-amount-btns"></div>
            </div>
